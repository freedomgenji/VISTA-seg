...
OUTPUT_ROOT_DEFAULT = "/root/shared-nvme/qual_preds_2023/metaviewer_full_meta"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Export MetaViewer BraTS2023 single-case predictions for qualitative panels.")
