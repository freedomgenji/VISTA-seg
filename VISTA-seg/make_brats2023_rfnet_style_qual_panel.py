...
METHODS = OrderedDict([
    ...
    ("DC-seg", "DC-seg_2023"),
    ("Ours", "metaviewer_full_meta_2023"),
])
...
def parse_args():
    ...
    parser.add_argument(
        "--methods",
        default="all",
        help='Use "all" or comma-separated method display names, e.g. "metaviewer_full_meta" or "RFNet,mmFormer,DC-seg,metaviewer_full_meta".',
    )
