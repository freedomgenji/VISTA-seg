...
mask_array = np.array([[False, True], [True, False], [True, True]])

class WMH_loadall_nii(Dataset):
    def __init__(self, transforms='', root=None, modal='all', num_cls=2, train_file='train.txt'):
    ...
    def __getitem__(self, index):
        ...
        return x, yo[1:,...], mask, name

    def __len__(self):
        return len(self.volpaths)

class WMH_loadall_test_nii(Dataset):
    def __init__(self, transforms='', root=None, modal='all', num_cls=2, test_file='test.txt'):
