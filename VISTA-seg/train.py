...
parser.add_argument('--shared_rep_method', default='metaviewer', choices=['metaviewer'], type=str)
...
parser.add_argument('--meta_align_weight', default=0.01, type=float,
                    help='Fixed loss weight for full-view teacher alignment in MetaViewer mode.')
parser.add_argument('--meta_feature_weight', default=0.2, type=float,
                    help='Fixed loss weight for feature-level reconstruction in MetaViewer mode.')
...
setup(args, 'training')
logging.info('MetaViewer fixed loss weights: meta_feature_weight=%s, meta_align_weight=%s',
